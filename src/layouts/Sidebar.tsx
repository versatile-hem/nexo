...
// Note: Products is excluded from topNav to restrict access to admin role only
// It's shown conditionally in the UI based on isAdmin check below
const topNav = [
      ...
      <nav className="space-y-1">
        ...
        {opsView ? (
          <>
            ...
            >
              <Activity size={16} />
              {!collapsed ? <span>Stock Movements</span> : null}
            </NavLink>
